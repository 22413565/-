...
flowchart LR
    ...
    Kitchen((Kitchen))
    Store((Store))
    StorePCActor((Store PC Manager))
    Admin((Admin))
    POS((POS System))
    Server((WTOrder Server))
    DB((Database))

    subgraph Customer_App[Customer App]
        UC1[View Menu]
        UC2[Add Order]
        UC3[Confirm Order]
        UC4[Call Staff]
    ...
    subgraph Kitchen_App[Kitchen App]
        UC5[Receive Order]
        UC12[Monitor Orders]
    end

    subgraph Store_App[Store App]
        UC7[Manage Menu]
        UC8[Upload Photo]
        UC9[Edit Description]
        UC10[Set Price]
        UC11[Control Sold-out]
        UC12B[Monitor Orders]
    end

    subgraph Store_PC[Store PC Manager]
        UC14[Manage Tables]
    ...
    subgraph Admin_App[Admin App]
        UC23[Manage Store Information]
        UC24[Monitor Store Data]
    end

    subgraph POS_Area[POS System]
        UC6[Print Kitchen Ticket]
        UC13[Print Store Ticket]
    end

    subgraph Server_Area[WTOrder Server]
        UC18[Process Order]
        UC19[Manage Data]
    end

    subgraph Database_Area[Database]
